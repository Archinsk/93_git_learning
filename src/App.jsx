    ...
    <>
      ...
      <div className="commit">
        ...
        <div className="commit-body">
          <ol>
            ...
            <li>
              В проект добавлена директория "styles" для хранения файлов таблиц
              стилей
            </li>
            <li>
            ...
            <li>
              ...
              <code>git config --global user.email "mgp-nsk@yandex.ru"</code>{" "}
            ...
            <li>
              Командой <code>git status</code> получен статус текущего положения
              проекта. Ветка "main", ещё нет коммитов, есть неотслеживаемые
              файлы и папки
            </li>
            <li>
              Просмотрен файл ".gitignore" с указанием файлов и каталогов,
              которые не должны отслеживаться и не должны попасть в репозиторий.
              Присутствуют "node modules", ".vscode/*", "dist" и другие
            </li>
            <li>
              Командой <code>git add .</code> к отслеживанию добавлены все файлы
              и папки проекта
            </li>
            <li>
              Командой <code>git commit -m "Project Init"</code> создан первый
              коммит
            </li>
            <li>
              На странице https://github.com/ пройдена авторизация пользователя
              Archinsk и создан репозиторий 93_git_learning
            </li>
            <li>
              Командой{" "}
              <code>
            ...
            <li>
              Командой <code>git push -u origin main</code> проект загружен в
              удаленный репозиторий
            </li>
            <li>
              На рабочем месте №2 пройдена авторизация пользователя Archinsk на
              https://github.com/ и скопирован адрес репозитория 93_git_learning
              на вкладке Code/SSH (git@github.com:Archinsk/93_git_learning.git)
            </li>
            <li>
              В директории с проектами выполнена команда{" "}
              <code>git clone git@github.com:Archinsk/93_git_learning.git</code>
              , проект клонирован из удаленного репозитория GitHub на рабочее
              место №2
            </li>
            <li>
              Установлены npm-модули командой <code>npm install</code>. Пакеты
              модулей установлены, проект запущен на рабочем месте №2
            </li>
            ...
            <li>
              Командой <code>git commit --amend --no-edit</code> зафиксированные
              изменения добавлены в последний коммит без изменения заголовка
              коммита
            </li>
            <li>
      ...
      <div className="commit">
        ...
        <div className="commit-body">
          <ol>
            <li>
              Настроены базовые стили элемента body: фоновый цвет, цвет текста,
              размер шрифта и высота строки основного текста
            </li>
            <li>
            ...
            <li>
              ...
              семейства и размера шрифта, горизонтальных паддингов и скруглений
              границ
            </li>
          </ol>
        </div>
